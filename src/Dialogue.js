        ...
        return (
            <div id="dialogue-box">
                ...
                <img style={{ cursor: 'pointer' }} 
                    ...
                    alt=""
                />
                {this.props.dialogueIndex === 2 && <Input onSubmit={this.props.makeTrainer}/>}
...
const messages = ['Welcome to the World of POKéMON!', 'What is your name?', `This is a dialogue`, 'this is a dialogue too.']
