...
export class Dialogue extends Component {
    render() {
        return (
            <div onClick={this.props.onClick} style={{ cursor: 'pointer' }} id="dialogue-box">
                <p id="dialogue-text">{messages[this.props.dialogueIndex]}</p>
...
const messages = ['Welcome to the World of POKéMON!', 'What is your name?']
